...
ax.axhline(25, color="blue", linestyle="--", lw=1, label="Roomtemp")
ax.axhline(40, color="orange", linestyle="--", lw=1, label="Average day in Texas")
ax.axhline(50, color="yellow", linestyle="--", lw=1, label="Volcano erruption nearby")
ax.axhline(73, color="red", linestyle="--", lw=1, label="Chicken is cooked")
ax.axhline(100, color="green", linestyle="--", lw=1, label="Water is boiling")
