...
Microwave_Menu:
    lcall Keypad                    ; Scan for key press
...
Microwave_Cook:
    Load_X_Var32(tempFinal)       ; Check actual temp
    Load_Y_Var16(microwave_temp)  ; Check target
...
Tmr_Logic:
    ...
    mov FSM_state, #10            ; Go to done state
Cook_E:
    ret
